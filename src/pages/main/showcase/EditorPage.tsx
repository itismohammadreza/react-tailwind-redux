  ...
  return (
      <>
        <FormContainer className="flex flex-col gap-2 p-10" initialValues={{}} onSubmit={v => console.log(v)}>
          <Editor label="label" labelPosition="float" name="n"/>

          <Editor label="label" labelPosition="fix-side" name="n"/>
          <Editor label="label" labelPosition="fix-top" name="n"/>

          <Editor name="n" iconPosition="right" icon="pi pi-search"/>
          <Editor name="n" iconPosition="left" icon="pi pi-search"/>

          <Editor addon={{after: {type: 'button', icon: 'pi pi-search'}}} name="n"/>
          <Editor addon={{before: {type: 'button', icon: 'pi pi-search'}}} name="n"/>

          <Editor label="label" labelPosition="float" icon="pi pi-search" iconPosition="right" name="n"/>
